...
#########
# Configure
./Configure linux-x86_64 --prefix=/opt/musl --openssldir=/etc/ssl no-shared no-bf no-cast no-md2 no-mdc2 no-rc2 no-rc4 no-rc5 no-idea no-ripemd no-ec no-dso no-camellia no-jpake no-md4 no-srp no-ssl2 no-ssl3
