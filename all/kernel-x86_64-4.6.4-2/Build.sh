...
# Mellanox driver
MLNX=$PKGDIR/mlnx-en-3.3

rm -rf include/linux/mlx4
rm -rf drivers/net/ethernet/mellanox/mlx4
cp -r $MLNX/drivers/net/ethernet/mellanox/mlx4 drivers/net/ethernet/mellanox || exit 1
cp -r $MLNX/include/linux/mlx4 include/linux || exit 1
cp $PKGDIR/mlx4_compat_config.h drivers/net/ethernet/mellanox/mlx4

# add #include <linux/netdevice.h> to include/linux/mlx4/cmd.h
sed -i '38 a #include <linux/netdevice.h>' include/linux/mlx4/cmd.h

sed -i 's/strnicmp/strncasecmp/' drivers/net/ethernet/mellanox/mlx4/main.c

# add #include <linux/timecounter.h> to mlx4/mlx4_en.h
# add #include "mlx4_compat_config.h" to mlx4/mlx4_en.h
# #include <net/busy_poll.h> to mlx4/mlx4_en.h
# #include <generated/uapi/linux/version.h> till mlx4/mlx4_en.h
sed -i '38 a #include <linux/timecounter.h>' drivers/net/ethernet/mellanox/mlx4/mlx4_en.h
sed -i '38 a #include "mlx4_compat_config.h"' drivers/net/ethernet/mellanox/mlx4/mlx4_en.h
sed -i '38 a #include <net/busy_poll.h>' drivers/net/ethernet/mellanox/mlx4/mlx4_en.h
sed -i '38 a #include <generated/uapi/linux/version.h>' drivers/net/ethernet/mellanox/mlx4/mlx4_en.h

sed -i 's/compat_hlist_for_each_entry_rcu/hlist_for_each_entry_rcu/' drivers/net/ethernet/mellanox/mlx4/en_rx.c
sed -i 's/compat_//' drivers/net/ethernet/mellanox/mlx4/en_netdev.c

# flytta #include "mlx4_en.h" till toppen av mlx4/en_netdev.c
sed -i '34 a #include "mlx4_en.h"' drivers/net/ethernet/mellanox/mlx4/en_netdev.c

# #include "mlx4_compat_config.h" till mlx4/cmd.c
sed -i '48 a #include "mlx4_compat_config.h"' drivers/net/ethernet/mellanox/mlx4/cmd.c
