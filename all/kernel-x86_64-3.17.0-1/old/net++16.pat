diff -urN linux/kernel/bpf/core.c net-next-2.6/kernel/bpf/core.c
--- linux/kernel/bpf/core.c	2014-09-24 09:52:40.248613600 +0200
+++ net-next-2.6/kernel/bpf/core.c	2014-10-06 10:48:56.956867087 +0200
@@ -20,9 +20,14 @@
...
diff -urN linux/kernel/bpf/Makefile net-next-2.6/kernel/bpf/Makefile
--- linux/kernel/bpf/Makefile	2014-09-24 09:52:40.248613600 +0200
+++ net-next-2.6/kernel/bpf/Makefile	2014-10-06 10:48:56.956867087 +0200
@@ -1 +1,5 @@
-obj-y := core.o
...
+obj-y += test_stub.o
+endif
diff -urN linux/kernel/bpf/syscall.c net-next-2.6/kernel/bpf/syscall.c
--- linux/kernel/bpf/syscall.c	1970-01-01 01:00:00.000000000 +0100
+++ net-next-2.6/kernel/bpf/syscall.c	2014-10-06 10:48:56.956867087 +0200
@@ -0,0 +1,606 @@
...
+	return err;
+}
diff -urN linux/kernel/bpf/test_stub.c net-next-2.6/kernel/bpf/test_stub.c
--- linux/kernel/bpf/test_stub.c	1970-01-01 01:00:00.000000000 +0100
+++ net-next-2.6/kernel/bpf/test_stub.c	2014-10-06 10:48:56.956867087 +0200
@@ -0,0 +1,116 @@
+/* Copyright (c) 2011-2014 PLUMgrid, http://plumgrid.com
+ *
+ * This program is free software; you can redistribute it and/or
...
diff -urN linux/kernel/bpf/verifier.c net-next-2.6/kernel/bpf/verifier.c
--- linux/kernel/bpf/verifier.c	1970-01-01 01:00:00.000000000 +0100
+++ net-next-2.6/kernel/bpf/verifier.c	2014-10-06 10:48:56.956867087 +0200
@@ -0,0 +1,1923 @@
+/* Copyright (c) 2011-2014 PLUMgrid, http://plumgrid.com
+ *
+ * This program is free software; you can redistribute it and/or
