...
pkg_install musl-xproto-7.0.18-1 || exit 2
pkg_install musl-util-macros-1.13.0-1 || exit 2
...
#########
# Configure
B-configure-2 --prefix=/opt/musl --bindir=/usr/bin || exit 1
